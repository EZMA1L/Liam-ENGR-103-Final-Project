...
void loop() {
  ...
  if (switch_intFlag) {
    ...
    if (leftButton_intFlag && rightButton_intFlag && game_Level == 0) {
      delay(500);
    ...
    if (leftButton_intFlag == 1 && rightButton_intFlag == 1 && game_Level == 2) {
      delay(500);
    ...
    if (leftButton_intFlag) {
      ...
      CircuitPlayground.setPixelColor(2, 0, 100, 150);
      delay(60);
      CircuitPlayground.setPixelColor(1, 0, 100, 150);
      CircuitPlayground.setPixelColor(3, 0, 100, 150);
      delay(80);
      CircuitPlayground.setPixelColor(0, 0, 100, 150);
      CircuitPlayground.setPixelColor(4, 0, 100, 150);
      delay(120);
      CircuitPlayground.clearPixels();
    ...
    if (rightButton_intFlag) {
      ...
      CircuitPlayground.setPixelColor(7, 0, 100, 150);
      delay(60);
      CircuitPlayground.setPixelColor(8, 0, 100, 150);
      CircuitPlayground.setPixelColor(6, 0, 100, 150);
      delay(80);
      CircuitPlayground.setPixelColor(9, 0, 100, 150);
      CircuitPlayground.setPixelColor(5, 0, 100, 150);
      delay(120);
      CircuitPlayground.clearPixels();
...
void game_User_Input_Level() {
  if (Mode == 0 && switch_intFlag) {
    ...
    for (int i = 0; i < game_Difficulty_Input; i++) {
      if (game_Pattern_Int[i] == 1)  // if left side
      {
        for (int a = 255; a > 0; a--) {
          delay(2);
          for (int i = 0; i < 5; i++) {
            CircuitPlayground.setPixelColor(left_Leds[i], 0, 0, a);
            if (leftButton_intFlag) {
      ...
      if (game_Pattern_Int[i] == 2)  // if right side
      {
        for (int a = 255; a > 0; a--) {
          delay(2);
          for (int i = 0; i < 5; i++) {
            CircuitPlayground.setPixelColor(right_Leds[i], a, 0, 0);
            if (rightButton_intFlag) {
    ...
    if (user_Pattern_Int[0, 1, 2, 3] == game_Pattern_Int[0, 1, 2, 3] && Mode == 0) {
      level_Win = 1;
    }
    for (int i = 0; i < game_Difficulty; i++) {
